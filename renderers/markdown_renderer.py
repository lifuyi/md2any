...
class MarkdownRenderer:
    ...
    def render(self, markdown_text: str, theme: Dict[str, Any], mode: str = "light-mode", platform: str = "wechat") -> str:
    ...
    def render_with_custom_styles(self, markdown_text: str, custom_styles: Dict[str, str], mode: str = "light-mode", platform: str = "wechat") -> str:
