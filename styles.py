...
STYLES = {
    ...
    "styles": {
      ...
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 12px 0;",
      "ol > li::before": "content: counter(item); position: absolute; left: -24px; top: 0; color: #ff6a00; font-weight: 600;",
    ...
    "dark-mode": {
      ...
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 12px 0;",
      "ol > li::before": "content: counter(item); position: absolute; left: -24px; top: 0; color: #ff9a4d; font-weight: 600;",
  ...
  "business": {
    ...
    "styles": {
      ...
      "ol": "\n  padding-left: 20px;\n",
      "li": "\n  position: relative;\n  \n  \n  margin-bottom: 12px;\n  color: #334155;\n  line-height: 1.6;\n  font-size: 15px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 12px;",
  ...
  "darktech": {
    ...
    "styles": {
      ...
      "li": "\n  position: relative;\n  \n  \n  margin-bottom: 16px;\n  padding-left: 40px;\n  color: #a4b1cd;\n  line-height: 1.6;\n  font-size: 14px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 16px; padding-left: 40px;",
  ...
  "dreamy": {
    ...
    "styles": {
      ...
      "ol": "\n  background: rgba(255, 255, 255, 0.7);\n  border-radius: 12px;\n  padding: 20px 25px;\n  box-shadow: 0 4px 15px rgba(0, 0, 0, 0.03);\n  border: 1px solid rgba(124, 141, 255, 0.1);\n  counter-reset: item;\n  transition: all 0.3s ease;\n",
      "li": "\n  position: relative;\n  \n  \n  margin: 16px 0;\n  padding-left: 46px;\n  color: #666;\n  font-size: 15px;\n  transition: all 0.3s ease;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 16px 0; padding-left: 46px;",
      "ol > li::before": "content: counter(item); position: absolute; left: 0; top: 0; color: #5e6fff; font-weight: 600; background: rgba(94, 111, 255, 0.1); width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center;",
    ...
    "dark-mode": {
      ...
      "li": "\n  position: relative;\n  \n  \n  margin: 16px 0;\n  padding-left: 46px;\n  color: #a0a8c0;\n  font-size: 15px;\n  transition: all 0.3s ease;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 16px 0; padding-left: 46px;",
      "ol > li::before": "content: counter(item); position: absolute; left: 0; top: 0; color: #8c9eff; font-weight: 600; background: rgba(140, 158, 255, 0.15); width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center;",
  ...
  "fairytale": {
    ...
    "styles": {
      ...
      "ol": "\n  list-style: none;\n  padding: 0.5em 3.5em;\n  counter-reset: decorated-counter;\n  margin-bottom: 1.5em;\n",
      "li": "\n  position: relative;\n  \n  \n  margin-bottom: 20px;\n  padding-left: 36px;\n  color: #555;\n  font-size: 16px;\n  font-family: \"Comic Sans MS\", \"PingFang SC\", sans-serif;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 20px; padding-left: 36px;",
  ...
  "japanese-magazine": {
    ...
    "styles": {
      ...
      "li": "\n  \n  \n  margin-bottom: 15px;\n  color: #333;\n  line-height: 1.6;\n  font-size: 16px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 15px;",
  ...
  "minimal": {
    ...
    "styles": {
      ...
      "ol": "\n  padding-left: 20px;\n",
      "li": "\n  position: relative;\n  \n  \n  margin: 16px 0;\n  color: #555;\n  font-size: 16px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 16px 0;",
  ...
  "nature": {
    ...
    "styles": {
      ...
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 24px; padding-left: 40px;",
  ...
  "notebook": {
    ...
    "styles": {
      ...
      "ol": "\n  padding-left: 20px;\n",
      "li": "\n  position: relative;\n  \n  \n  margin-bottom: 20px;\n  color: #34495e;\n  line-height: 24px;\n  font-size: 15px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 20px;",
  ...
  "traditional-chinese": {
    ...
    "styles": {
      ...
      "ol": "\n  list-style: none;\n  padding: 0.5em 3.5em;\n  counter-reset: decorated-counter;\n  margin-bottom: 1.5em;\n",
      "li": "\n  position: relative;\n  \n  \n  margin-bottom: 20px;\n  padding-left: 40px;\n  color: #333;\n  font-size: 16px;\n  text-align: justify;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin-bottom: 20px; padding-left: 40px;",
  ...
  "warm": {
    ...
    "styles": {
      ...
      "ol": "\n  padding-left: 20px;\n",
      "li": "\n  position: relative;\n  \n  \n  margin: 20px 0;\n  padding-left: 42px;\n  color: #666;\n  font-size: 15px;\n",
      "ol > li": "position: relative; counter-increment: item; list-style: none; margin: 20px 0; padding-left: 42px;",
